...
# this must be set to False if metadata download links should be not displayed
METADATA_DOWNLOAD_ALLOWS = False

#Import uploaded shapefiles into a database such as PostGIS?
DB_DATASTORE =True

#Database datastore connection settings
DB_DATASTORE_DATABASE = 'geonode.import'
...
DB_DATASTORE_NAME = 'geonode.import'
